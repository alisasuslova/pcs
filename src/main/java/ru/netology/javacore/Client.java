...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (
                Socket socket1 = new Socket("localhost", 8989);
        ...
        try (
                Socket socket2 = new Socket("localhost", 8989);
        ...
        try (
                Socket socket3 = new Socket("localhost", 8989);
        ...
        try (
                Socket socket4 = new Socket("localhost", 8989);
        ...
        try (
                Socket socket5 = new Socket("localhost", 8989);
        ...
        try (
                Socket socket6 = new Socket("localhost", 8989);
